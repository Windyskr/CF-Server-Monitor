...
const createEditFormFromServer = (server) => ({
    ...
    interface_aliases: server.interface_aliases || '{}',
    interface_traffic_settings: server.interface_traffic_settings || '{}',
...
const buildEditPayloadFromForm = (form) => {
  ...
  return {
    payload: {
      ...
      interface_aliases: form.interface_aliases,
      interface_traffic_settings: form.interface_traffic_settings,
...
const saveEdit = async () => {
  ...
  const data = {
    ...
    interface_aliases: editForm.value.interface_aliases,
    interface_traffic_settings: editForm.value.interface_traffic_settings,
