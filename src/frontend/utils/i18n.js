...
const translations = reactive({
  en: {
    ...
    interfaceTrafficSettings: 'Interface traffic settings',
    ...
    rebuildTrafficBaselines: 'Initialize',
    rebuildingTrafficBaselines: 'Initializing...',
    rebuildTrafficBaselinesSuccess: 'Traffic baselines initialized: {updated} succeeded, {failed} failed, {skipped} skipped.',
    rebuildTrafficBaselinesFailed: 'Failed to initialize traffic baselines',
  ...
  zh: {
    ...
    networkInterfaces: '网卡流量',
    interfaceAliases: '网卡别名',
    interfaceTrafficSettings: '网卡流量设置',
    ...
    rebuildTrafficBaselines: '初始化',
    rebuildingTrafficBaselines: '初始化中...',
    rebuildTrafficBaselinesSuccess: '流量基线初始化完成：成功 {updated} 台，失败 {failed} 台，跳过 {skipped} 台。',
    rebuildTrafficBaselinesFailed: '流量基线初始化失败',
